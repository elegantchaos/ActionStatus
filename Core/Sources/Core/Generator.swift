...
public class Generator {
    ...
    public let compilers = [
        ...
        Compiler("swift-56", name: "Swift 5.6", short: "5.6", linux: "swiftlang/swift:nightly-5.6-bionic", mac: .toolchain(version: "13.2.1", branch: "swift-5.6-RELEASE", image: "macos-11")),             // https://download.swift.org/swift-5.6-release/xcode/swift-5.6-RELEASE/swift-5.6-RELEASE-osx.pkg
        
        Compiler("swift-nightly", name: "Swift Development Nightly", short: "dev", linux: "swiftlang/swift:nightly", mac: .toolchain(version: "13.2.1", branch: "development", image: "macos-11")),         // https://download.swift.org/development/xcode/swift-DEVELOPMENT-SNAPSHOT-2022-03-22-a/swift-DEVELOPMENT-SNAPSHOT-2022-03-22-a-osx.pkg
    ]
