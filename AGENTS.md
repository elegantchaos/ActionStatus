...
This repository contains ActionStatus, an Xcode app for iOS, tvOS, and macCatalyst, with shared logic in the local Swift package under `Core/`.
...
- Keep shared logic in `Core/Sources/Core` when possible.
